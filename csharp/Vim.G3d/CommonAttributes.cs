...
namespace Vim.G3d
{
	public static class CommonAttributes
	{
		...
		public static string GroupMaterialId = "g3d:group:materialid:0:int32:1";
		public static string GroupObjectId = "g3d:group:objectid:0:int32:1";
		public static string GroupColor = "g3d:group:color:0:float32:4";
		public static string SubGeoVertexOffset = "g3d:subgeo:vertexoffset:0:int32:1";
		public static string SubGeoIndexOffset = "g3d:subgeo:indexoffset:0:int32:1";
	...
	public static class CommonAttributeExtensions
	{
		...
		public static GeometryAttribute<int> ToGroupMaterialIdAttribute(this IArray<int> xs, int index) => xs.ToAttribute(CommonAttributes.GroupMaterialId, index);
		public static GeometryAttribute<int> ToGroupMaterialIdAttribute(this IArray<int> xs) => xs.ToAttribute(CommonAttributes.GroupMaterialId);
		public static GeometryAttribute<int> ToGroupMaterialIdAttribute(this int[] xs, int index) => xs.ToIArray().ToGroupMaterialIdAttribute(index);
		public static GeometryAttribute<int> ToGroupMaterialIdAttribute(this int[] xs) => xs.ToIArray().ToGroupMaterialIdAttribute();
		public static GeometryAttribute<int> GetAttributeGroupMaterialId(this IGeometryAttributes self) => self.GetAttribute<int>(CommonAttributes.GroupMaterialId);
		public static IArray<int> GetAttributeDataGroupMaterialId(this IGeometryAttributes self) => self.GetAttributeGroupMaterialId()?.Data;
		public static GeometryAttribute<int> ToGroupObjectIdAttribute(this IArray<int> xs, int index) => xs.ToAttribute(CommonAttributes.GroupObjectId, index);
		public static GeometryAttribute<int> ToGroupObjectIdAttribute(this IArray<int> xs) => xs.ToAttribute(CommonAttributes.GroupObjectId);
		public static GeometryAttribute<int> ToGroupObjectIdAttribute(this int[] xs, int index) => xs.ToIArray().ToGroupObjectIdAttribute(index);
		public static GeometryAttribute<int> ToGroupObjectIdAttribute(this int[] xs) => xs.ToIArray().ToGroupObjectIdAttribute();
		public static GeometryAttribute<int> GetAttributeGroupObjectId(this IGeometryAttributes self) => self.GetAttribute<int>(CommonAttributes.GroupObjectId);
		public static IArray<int> GetAttributeDataGroupObjectId(this IGeometryAttributes self) => self.GetAttributeGroupObjectId()?.Data;
		public static GeometryAttribute<Vector4> ToGroupColorAttribute(this IArray<Vector4> xs, int index) => xs.ToAttribute(CommonAttributes.GroupColor, index);
		public static GeometryAttribute<Vector4> ToGroupColorAttribute(this IArray<Vector4> xs) => xs.ToAttribute(CommonAttributes.GroupColor);
		public static GeometryAttribute<Vector4> ToGroupColorAttribute(this Vector4[] xs, int index) => xs.ToIArray().ToGroupColorAttribute(index);
		public static GeometryAttribute<Vector4> ToGroupColorAttribute(this Vector4[] xs) => xs.ToIArray().ToGroupColorAttribute();
		public static GeometryAttribute<Vector4> GetAttributeGroupColor(this IGeometryAttributes self) => self.GetAttribute<Vector4>(CommonAttributes.GroupColor);
		public static IArray<Vector4> GetAttributeDataGroupColor(this IGeometryAttributes self) => self.GetAttributeGroupColor()?.Data;
