...
namespace Vim
{
	namespace G3d
	{
		...
		public:
			...
			String^ AttributeName(int n)
			{
				return gcnew String(g3d->attributes[n].descriptor.to_string().c_str());
			}

			int AttributeElementCount(int n)
			{
				return (int)g3d->attributes[n].num_elements();
			}
		};
	}
}
